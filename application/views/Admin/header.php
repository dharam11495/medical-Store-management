    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item active">
        <a class="nav-link" href="<?= base_url('welcome/consumed'); ?>"><b style="color: white;">Consumed Medicine</b></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?= base_url('welcome/consumedSheet'); ?>"><b style="color: white;">Consumed Sheet</b></a>
      </li>
